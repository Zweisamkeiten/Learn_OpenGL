...
int main()
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        CubeShader.use();
        CubeShader.setVec3("material.ambient", 0.1f, 0.18725f, 0.1745f);
        CubeShader.setVec3("material.diffuse", 0.396f, 0.74151f, 0.69102f);
        CubeShader.setVec3("material.specular", 0.2972254f, 0.30829f, 0.306678f);
        CubeShader.setFloat("material.shininess", 0.1f);
